...
[Telegram](https://t.me/rhyolite_sync) • [Site](https://rhyolite.nogipx.ru)
...
| Plugin UI configuration (vault id, last-used server URL) | `.obsidian/plugins/rhyolite_sync/data.json` |
