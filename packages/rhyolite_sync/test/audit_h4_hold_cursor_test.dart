...
void main() {
  group('H4 — hold-cursor holds AND releases', () {
    test('a failed file holds the cursor below it, yet every healthy record '
        '(including those AFTER it) still applies', () async {
    ...
    test('two failing files with interleaved seqs hold the cursor under the '
        'GLOBAL MINIMUM failed seq, not the last', () async {
      ...
      expect(
        ...
        1,
        reason:
            'must hold at min(failed seqs)-1 = 2-1 = 1 so BOTH B and D '
