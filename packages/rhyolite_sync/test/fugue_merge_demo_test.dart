...
void main() {
  ...
  test(
    'large concurrent edit merges losslessly (normal + deadline path)',
    () async {
  ...
  test(
    'two huge, different offline rewrites of the same note both survive',
    () async {
      ...
      final aBig =
          ...
          doc([
            for (var i = 1; i <= 12; i++)
              'A: point ${i.toString().padLeft(2, '0')}',
          ]);
